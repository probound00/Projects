...
public final class RSSReader {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        out.println("<head>");
        out.println("<title>");
        //setting titleloc to index of its respective child
        ...
        //checking if description has a child
    ...
    private static int getChildElement(XMLTree xml, String tag) {
        ...
        //set loc to -1
        int loc = -1;
        //looping through all children to find tag
        for (int i = 0; i < xml.numberOfChildren(); i++) {
            if (xml.child(i).label().equals(tag)) {
                //if tag is found loc = i
                loc = i;
            }
        }
        //returns unchanged loc, which is -1, if nothing was found
        return loc;
    }
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        if (locTitle != -1 && item.child(locTitle).numberOfChildren() > 0) {
            ...
            //if link exists, print hyperlink
            if (locLink != -1) {
                String linkLabel = item.child(locLink).child(0).label();
    ...
    public static void main(String[] args) {
        ...
        XMLTree xml = new XMLTree1(urlName);
        //keep prompting for new file if it does not meet requirements
        while (xml.label() != "feeds" || !(xml.hasAttribute("title"))) {
            out.print("Please enter a file: ");
            urlName = in.nextLine();
            xml = new XMLTree1(urlName);
        }
